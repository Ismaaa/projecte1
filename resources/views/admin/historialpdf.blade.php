    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10 col-sm-8 main-content">
                ...
                <h1>Llistat d'usuaris que han generat PDF's</h1>
                ...
                <table class="table table-hover">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>Acció realitzada</th>
                            <th>Temps que ha passat</th>
                            <th>Data de generació</th>
                        </tr>
                    </thead>
                    @foreach($historials as $historial)
                        <tbody>
                            <tr>
                                <td>{{ $historial->id }}</td>
                                <td>{{ $historial->user->id }}</td>
                                <td>{{ $historial->user->name }}</td>
                                <td>{{ $historial->accio }}</td>
                                <td>{{ Carbon\Carbon::parse($historial->created_at)->diffForHumans() }}

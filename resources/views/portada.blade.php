                        ...
                        <div class="col-sm-10">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    @if($publication->user->id==1)
                                        <span class="label label-danger">Administrador</span>
                                        <span class="label label-success">Master</span>
                                    @elseif($publication->user->admin)
                                        <span class="label label-danger">Administrador</span>
                                    @else
                                        <span class="label label-primary">Membre</span>
                                    @endif
                                    <span class="text-muted" style="float: right">{{ Carbon\Carbon::parse($publication->created_at)->diffForHumans() }}</span><br>
                                    <span class="label label-info" style="float: right">Publicació numero: #{{ $publication->id }}</span>
                                </div>
                                ...
                                <div class="widget-area no-padding blank">
                                    <div class="status-upload">
                                        <div class="form-group{{ $errors->has('text') ? ' has-error' : '' }}">
                                            ...
                                            {{ csrf_field() }}
                                                {!! Form::textarea('text', null, ['class' => 'form-control','placeholder' => 'Hola a tothom!!']) !!}
                                                @if ($errors->has('text'))
